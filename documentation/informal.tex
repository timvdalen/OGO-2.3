...
\end{figure}
\FloatBarrier
\subsection{Het bouwen van gebouwen}
De speler kan ook opdracht geven om op een bepaalde plek een gebouw te laten bouwen. Om een gebouw te bouwen, moet de speler eerst op de knop \textsc{b} drukken. Op dat moment wordt er een menu op het scherm van de speler afgebeeld. Door middel van sneltoetsen kan de speler een gebouw van dit menu kiezen. Merk op dat de muis op dit moment nog steeds de kijkrichting bestuurt. Als het gebouw gekozen is, wordt op de ondergrond een rooster getekend. Door middel van het vizier, kan de speler een plek op de grid aanwijzen. De speler kan door te klikken dan de opdracht geven om het gebouw te laten bouwen. Op elk moment kan dit proces afgebroken worden door op de knop \textsc{b} te drukken.
\section{Optioneel}
\label{sec:OPT}
