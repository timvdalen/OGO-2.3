...
\newcommand{\ON}{Orientatie}
\newcommand{\MW}{Werkplan}
\newcommand{\MS}{SpelSpec}
\newcommand{\MA}{Spelkeus}
\newcommand{\BO}{Deel Omschr.}
\newcommand{\OC}{Comm.Prot.}
\newcommand{\MN}{NtwrkComm}
\newcommand{\CT}{Comm.Testen}
\newcommand{\MK}{Klas.diagr.}
\newcommand{\MT}{Taakverdel.}
\newcommand{\IS}{Impl.}
\newcommand{\BG}{Handl.}
\newcommand{\AV}{Afrond.Versl.}
\newcommand{\ME}{Mkn.prsnt.}
\newcommand{\EP}{Prsntrn}
...
\begin{document}
    ...
    \item[-] Maken spelspecificatie (\emph{\MS}).
    ...
    \appendix
    \section{Gedetailleerde uitwerking}
        \begin{figure}[H]
        \scriptsize
